...
Line 17:42 Transforming class syntax to the configured target environment ("es5") is not supported yet
Line 18:15 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 39:21 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 59:24 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 73:12 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 80:20 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 86:23 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 91:45 Transforming destructuring to the configured target environment ("es5") is not supported yet
Line 92:10 Transforming const to the configured target environment ("es5") is not supported yet
Line 93:10 Transforming const to the configured target environment ("es5") is not supported yet
